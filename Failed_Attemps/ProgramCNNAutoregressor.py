...
#
# CNN + Autoregressive MLP — Human Motion Prediction
...
from ai4animation.AI.Models import CNNAutoregressor
...
FRAME_DIM     = 12 * len(BONES)   # 324
HIDDEN_DIM    = 512                # same as AutoregressionMLP
CNN_CHANNELS  = 512
WINDOW_SIZE   = 8
STRIDE        = 2
...
class Program:
    ...
    def GetTrainingFeatures(self, batch):
        ...
        # [Batch, WindowSize, FrameDim] — 3D, NOT flattened
