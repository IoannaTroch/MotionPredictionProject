# ============================================================================
# Erwthma 5 (meros A): PROBABILISTIC autoregressive montelo me FLOW MATCHING
# sto RAW xwro (h pithanotiki ekdosi tou Erwthmatos 3 / AutoregressionMLP).
#
# Provlepei to epomeno kare ths kinhshs me vash ena parathuro apo prohgoumena
# kare, alla anti gia nteterministiko MLP xrhsimopoiei pithanotiko Flow Matching.
#
# Otan teleiwsei to training apothikeuei to montelo se: flow_matching_raw_model.pth
# Gia na to deis sto GUI trekse meta to: ProgramFlowMatchingInference.py
# ============================================================================
import os
import sys
...
MODEL_PATH = "flow_matching_raw_model.pth"
...
class Program:
    ...
    def Training(self):
        ...
        for epoch in range(1, EPOCH_COUNT + 1):
            ...
            # -------- VALIDATION --------
            # idio flow-matching loss, alla xwris update statistics kai xwris grad
            self.Network.eval()
            epoch_val_loss = 0.0
            with torch.no_grad():
        ...
        # apothikeush olou tou montelou gia xrhsh sto GUI (ProgramFlowMatchingInference.py)
