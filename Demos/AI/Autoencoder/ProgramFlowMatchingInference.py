# ============================================================================
# GUI INFERENCE - Flow Matching sto RAW xwro (Erwthma 5, meros A)
#
# Fortwnei to apothikeumeno montelo 'flow_matching_raw_model.pth' kai trexei
# to provlhmatiko grafiko perivallon (STANDALONE) XWRIS ekpaideush.
# Prepei prwta na exei trexei to ProgramFlowMatching.py wste na uparxei to .pth.
#
# Sto parathuro: o kokkinos Actor deixnei to epomeno kare pou paragei to montelo
# me vash to istoriko apo ton MotionEditor.
# ============================================================================
import os
import sys
