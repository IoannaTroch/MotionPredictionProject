...
MODEL_PATH = os.path.join(PATH, "AutoregressiveMLP_model")
    ...
    def Training(self): 
        ...
        for epoch in range(1, EPOCH_COUNT + 1):
            ...
            for i, batch_data in enumerate(train_batches):
                ...
                loss = self.Network.learn(xBatch, yBatch, epoch == 1) 
            ...
            with torch.no_grad(): 
                for i, batch_data in enumerate(val_batches):
                    ...
                    loss = self.Network.learn(xBatch, yBatch, False)
        ...
        plt.ioff() 
        plt.savefig("loss_history_AutoregressiveMLP.png", dpi=300, bbox_inches='tight') 
